...
export const qk = {
  ...
  platformAdmin: {
    ...
    workspaceSubscription: (id: string) => ["platform-admin", "workspaces", "subscription", id] as const,
    ...
    contactLogs: (workspaceId: string) => ["platform-admin", "workspaces", "contact-logs", workspaceId] as const,
    ...
    staffMembers: () => ["platform-admin", "staff-members"] as const,
    staffInvitations: () => ["platform-admin", "staff-invitations"] as const,
    customerInvitations: (params?: Record<string, unknown>) => ["platform-admin", "customer-invitations", params] as const,
