...
export function PlatformAdminShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen">
      <aside className="hidden w-60 shrink-0 flex-col gap-1 bg-[hsl(222,20%,14%)] p-4 text-white md:flex">
        <div className="mb-6 px-2">
          <span className="text-lg font-bold">راصد</span>
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center justify-between border-b border-border bg-[hsl(222,20%,14%)] px-4 py-3 text-white md:hidden">
